...
app.post("/api/reviews", authenticateToken, async (req, res) => {
    ...
    try {
        // ✅ Ensure booking belongs to this customer and is completed
        ...
        // ✅ Insert review
        await pool.query(
            `INSERT INTO reviews (booking_id, service_id, customer_id, provider_id, rating, comment)
             VALUES (?, ?, ?, ?, ?, ?)`,
...
// GET REVIEWS FOR A SERVICE (Public or Logged In)
